...
1. [before-all-timers.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-all-timers.png) (All timers page pre-polish)
2. [before-week-page.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-week-page.png) (Week page pre-polish)
3. [before-month-page.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-month-page.png) (Month grid pre-polish with low-contrast out-of-month text 4.01:1)
4. [before-history-page.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-history-page.png) (Run history pre-polish)
5. [before-settings-page.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-settings-page.png) (Settings page pre-polish with 20px gutter)
6. [before-wizard-overlay.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-wizard-overlay.png) (Wizard overlay pre-polish)
7. [before-timer-dialog.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/before/before-timer-dialog.png) (Timer Dialog pre-polish)

### Authentic AFTER Screenshots (`docs/qa4-screenshots/after/`)
Generated from fresh build of current design system:
1. [p4f-list-after.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-list-after.png): All timers list with unified design tokens, 32px hit targets, and tabular numbers.
2. [p4f-week-after.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-week-after.png): Week calendar with day header badges and 32px target buttons.
3. [p4f-month-after.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-month-after.png): Month grid showing WCAG AAA compliant out-of-month text contrast (6.64:1) and 32px `.month-chip` buttons.
4. [p4f-history-after.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-history-after.png): Run history page with log filter dropdowns and event log tail.
5. [p4f-settings-after.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-settings-after.png): Settings page top section with 16px gutter (`--space-4`) and 32px checkboxes.
6. [p4f-settings-below-fold.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-settings-below-fold.png): Settings page scrolled to bottom showing Misfire defaults and Engine settings cards.
7. [p4f-wizard-after.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-wizard-after.png): First-run Wizard overlay showing backdrop and 32px checkboxes.
8. [p4f-empty-filter.png](file:///home/sami/bellman/.train-worktrees/2026-07-28_0011/docs/qa4-screenshots/after/p4f-empty-filter.png): Zero-result empty filter state showing `0 of 7 timers`, custom `#12161b` select dropdowns, and toast badge (`ℹ INFO`).
